...
export class Backend implements backendInterface {
    ...
    async deleteMedia(arg0: Time): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getMyMedia(): Promise<Array<MediaItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyMedia();
    ...
    async getUserMedia(arg0: Principal): Promise<Array<MediaItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserMedia(arg0);
                return from_candid_vec_n16(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadMedia(arg0: ExternalBlob, arg1: string | null, arg2: MediaType): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadMedia(await to_candid_ExternalBlob_n24(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n25(this._uploadFile, this._downloadFile, arg1), to_candid_MediaType_n26(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_MediaItem_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MediaItem): Promise<MediaItem> {
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        username: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.username))
    };
}
async function from_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        caption: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.caption)),
...
async function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MediaItem>): Promise<Array<MediaItem>> {
    return await Promise.all(value.map(async (x)=>await from_candid_MediaItem_n17(_uploadFile, _downloadFile, x)));
}
